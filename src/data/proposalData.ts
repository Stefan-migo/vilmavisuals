...
export const proposalData: Section[] = [
  {
    id: 'introduccion',
    title: 'INTRODUCCIÓN',
  ...
  },
  {
    ...
    content: [
      ...
      '  * Presentaciones Finales: Sábado 30 de Noviembre.',
  ...
  },
  {
    ...
    content: [
      'Dado el plazo de tiempo extremadamente ajustado, la metodología de trabajo se enfocará en la eficiencia, la comunicación constante y la entrega ágil de resultados, priorizando una estética similar a las referencias entregadas.',
      '',
      '**Diseño y Producción de Visuales / Animaciones** (3 Jornadas laborales completas estimadas)',
      '',
      '* Análisis de Referencias',
      '* Diseño de las 10 pantallas o visuales estáticos/semi-estáticos que servirán como base para cada escena principal.',
  ...
  },
  {
    ...
    content: [
      ...
      '* El proponente manejará el sistema de videomapping usando el proyector del Teatro Brújula, con un segundo proyector disponible sin costo extra si hace falta.'
    ]
  },
  {
    id: 'plazos',
    title: 'PLAZOS DE ENTREGA Y CRONOGRAMA',
    content: [
      '* Domingo 16 de Noviembre: Diseño y Producción de Visuales (Jornada Completa). Se realizará feedback dependiendo de disponibilidad.',
      '* Lunes 17 de Noviembre: Diseño y Producción de Visuales (Jornada Completa). Feedback obligatorio para la evaluación de cada pantalla/visual creada.',
      '* Martes 18 de Noviembre: Diseño y Producción de Visuales, preparación final y ajustes menores antes del ensayo general.',
